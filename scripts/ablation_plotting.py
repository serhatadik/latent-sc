...
ABLATION_FACTORS = {
    'whitening': {
        ...
        'baseline_variant': 'Hetero-Diagonal',
    },
    'beam_search': {
    ...
    'matched_model': {
        ...
        'type': 'comparison',
        'variants': [
            {'name': 'Ray Tracing',  'model_type': 'raytracing',   'recon_model_type': 'raytracing'},
            {'name': 'TIREM',        'model_type': 'tirem',        'recon_model_type': 'tirem'},
            {'name': 'Log-Distance', 'model_type': 'log_distance', 'recon_model_type': 'log_distance'},
        ],
        'baseline_variant': 'TIREM',
    },
}
